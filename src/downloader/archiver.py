...
class Archiver:
    ...
    def archive_chapter(
        ...
        if self.use_zip:
            self._create_zip(out_dir, chapter_num, series_title, image_files)
        else:
            self._create_cbz(out_dir, chapter_num, chapter_type, series_title, image_files)
